...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'FAIZAN', subtitle: '< website developer />' },
    { id: 'awards', position: [0, 0, -55], type: 'awards', title: 'SYMBIOTE', subtitle: 'CEO & Founder • SymbioteSystems' },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: 'JOURNEY', subtitle: 'Web Development • Karachi, Pakistan' },
    { id: 'skills', position: [0, 0, -135], type: 'skills', title: 'SKILLS', subtitle: 'Next.js • React • AI • Tailwind CSS' },
];
