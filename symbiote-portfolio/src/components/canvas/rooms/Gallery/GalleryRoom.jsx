...
const UNIQUE_PROJECTS = [
    {
        ...
        url: 'https://aqua-drill-solutions--sherazgaming81.replit.app/',
        description: 'Professional water well drilling company website with cinematic dark UI, service showcase and smart lead generation system. Built with Next.js and Tailwind CSS.',
    ...
    },
    {
        ...
        url: 'https://aquaverve-drilling-q86w.arcada.app/',
        description: 'Premium drilling solutions platform with modern design, interactive service pages and professional quote system. Features AI integration and stunning UI/UX.',
        techStack: ['/textures/gallery/reactlogo.webp', '/textures/gallery/csslogo.webp', '/textures/gallery/htmllogo.webp', '/textures/gallery/jslogo.webp']
    },
    {
        id: 'coming',
        title: 'COMING SOON',
        ...
        url: '#',
        description: 'Next project currently in development. Stay tuned for more innovative digital experiences from SymbioteSystems.',
        techStack: ['/textures/gallery/reactlogo.webp', '/textures/gallery/tailwindlogo.webp', '/textures/gallery/jslogo.webp', '/textures/gallery/htmllogo.webp']
    },
    {
        id: 'symbiote',
        title: 'SYMBIOTE',
        ...
        url: 'https://symbiotesystems.vercel.app/',
        description: 'The official SymbioteSystems website — our creative development studio hub showcasing services, portfolio and contact information.',
        techStack: ['/textures/gallery/reactlogo.webp', '/textures/gallery/tailwindlogo.webp', '/textures/gallery/csslogo.webp', '/textures/gallery/jslogo.webp']
    },
];
        ...
        <group ref={groupRef}>
            ...
            <group position={[0, -0.7, -2]}>
                ...
                <mesh position={[0, 5, -20]}>
                    ...
                    <meshBasicMaterial color="#BAE6FD" side={THREE.BackSide} transparent opacity={0.5} onBeforeCompile={onBeforeCompile} />
                </mesh>
            </group>
        </group>
    );
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <planeGeometry args={[1.2, 1.2 / 3.613]} />
                        <meshBasicMaterial color="#A5B4FC" transparent={true} opacity={0} />
                    </mesh>
                </group>
