...
const CorridorDecorations = ({ segmentLength, zOffset, corridorWidth = 4, corridorHeight = 3.5, zClip = 100000, setCameraOverride }) => {
    ...
    const frames = useMemo(() => [
        ...
        },
        {
            ...
            y: 0.25,
            id: 'frame-3',
            image: '/textures/corridor/achievement-showcase.webp',
            imagePainted: '/textures/corridor/achievement-showcase_painted.webp',
            imageWidth: 2.0,
            imageHeight: 1.2,
            offsetFromWall: 0.1,
            signature: "SymbioteSystems",
            signatureX: 0,
            signatureY: -0.55,
            signatureSize: 0.09,
        ...
        <group>
                ...
                return (
                    <group key={`light-${i}`} position={[0, ceilingY, light.z]}>
                        ...
                        <mesh position={[0, -0.03, 0]}>
                            ...
                            <meshBasicMaterial attach="material-0" color="#A5B4FC" roughness={0.6} />
                            <meshBasicMaterial attach="material-1" color="#A5B4FC" roughness={0.6} />
                            ...
                            */}
                            ...
                            <meshBasicMaterial color="#A5B4FC" attach="material-4" map={lampSideTexture} roughness={0.6} />
                            <meshBasicMaterial color="#A5B4FC" attach="material-5" map={lampSideTexture} roughness={0.6} />
                        </mesh>
            ...
            <group position={[tableConfig.x, floorY, tableConfig.z]} rotation={[0, Math.PI / 2, 0]}>
                ...
                {[
                    ...
                    <mesh key={`leg-${i}`} position={[pos[0], tableConfig.height / 2, pos[1]]}>
                        ...
                        <meshBasicMaterial color="#A5B4FC" map={legTexture} roughness={0.8} />
                    </mesh>
                ))}
                ...
                <mesh position={[0, tableConfig.height + tableConfig.topThickness / 2, 0]}>
                    ...
                    <meshBasicMaterial color="#A5B4FC" attach="material-0" map={woodTexture} /> {/* Right */}
                    <meshBasicMaterial color="#A5B4FC" attach="material-1" map={woodTexture} /> {/* Left */}
                    <meshBasicMaterial color="#A5B4FC" attach="material-2" map={tableTopTexture} roughness={0.5} /> {/* Top */}
                    <meshBasicMaterial attach="material-3" color="#A5B4FC" />   {/* Bottom */}
                    <meshBasicMaterial color="#A5B4FC" attach="material-4" map={woodTexture} /> {/* Front */}
                    <meshBasicMaterial color="#A5B4FC" attach="material-5" map={woodTexture} /> {/* Back */}
                </mesh>
            ...
            */}
            ...
            >
                ...
                */}
                <meshBasicMaterial color="#A5B4FC" attach="material-0" map={cabinetRestTexture} />
                <meshBasicMaterial color="#A5B4FC" attach="material-1" map={cabinetFrontTexture} />
                <meshBasicMaterial color="#A5B4FC" attach="material-2" map={cabinetRestTexture} />
                <meshBasicMaterial color="#A5B4FC" attach="material-3" map={cabinetRestTexture} />
                <meshBasicMaterial color="#A5B4FC" attach="material-4" map={cabinetRestTexture} />
                <meshBasicMaterial color="#A5B4FC" attach="material-5" map={cabinetRestTexture} />
            </mesh>
