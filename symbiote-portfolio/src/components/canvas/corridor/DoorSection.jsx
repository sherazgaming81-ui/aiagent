        ...
        <group position={[pivotX, position[1], position[2]]}>
            ...
            <group ref={groupRef}>
                ...
                <mesh position={[wallOffsetX, 0, 0]} geometry={wallWithHoleGeometry}>
                    <meshBasicMaterial color="#A5B4FC" map={wallTexture} roughness={1} metalness={0} side={THREE.DoubleSide} />
                </mesh>
                ...
                <group position={[wallOffsetX, -0.4, 0]}>
                    ...
                    <group ref={doorRef} position={[doorPivotX, 0, 0.01]}>
                        ...
                        >
                            ...
                            <meshBasicMaterial color="#A5B4FC" transparent={true} opacity={0} depthWrite={false} />
                        </mesh>
