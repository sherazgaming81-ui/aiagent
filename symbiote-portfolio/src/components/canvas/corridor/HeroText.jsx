...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    const letters = useMemo(() => [
        { char: 'S', baseX: -0.95, splitDir: -1.6, delay: 0 },
        { char: 'Y', baseX: -0.43, splitDir: -0.6, delay: 0 },
        { char: 'M', baseX: 0.23, splitDir: 0.6, delay: 0 },
        { char: 'B', baseX: 0.95, splitDir: 1.8, delay: 0 },
    ], []);

    // Tagline words for split effect
    const taglineWords = useMemo(() => [
        { text: '<', baseX: -0.85, splitDir: -1.5, delay: 0 },
        { text: 'website', baseX: -0.4, splitDir: -0.8, delay: 0 },
